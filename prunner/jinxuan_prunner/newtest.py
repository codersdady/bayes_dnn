...
model = torch.load("E:\pycharpro\model\jx0.pkl")
# print(model)
...
#
# del data['blankVotes']
# del data['numParishesApproved']
# del data['territoryName']
# del data['Party']
# del data['pre.nullVotes']
# del data['pre.nullVotesPercentage']
# del data['nullVotesPercentage']
# del data['pre.votersPercentage']
# del data['votersPercentage']
# del data['nullVotes']
# del data['blankVotesPercentage']
# del data['pre.blankVotesPercentage']
# del data['totalMandates']
# del data['numParishes']
# del data['subscribedVoters']
# del data['pre.totalVoters']
# del data['pre.subscribedVoters']
# del data['totalVoters']
# del data['pre.blankVotes']
# del data['availableMandates']
# del data['validVotesPercentage']
# del data['Percentage']
# del data['Votes']
# del data['Mandates']
...
# train_label = np.load('E:\\pycharpro\\prunner\\jinxuan_prunner\\train_label.npy')
# train_data = np.load('E:\\pycharpro\\prunner\\jinxuan_prunner\\train_data.npy')
# test_label = np.load('E:\\pycharpro\\prunner\\jinxuan_prunner\\test_label.npy')
# test_data = np.load('E:\\pycharpro\\prunner\\jinxuan_prunner\\test_data.npy')
# print(type(test_data))
# print(train_data)
...
for epoch in range(1000):
    ...
    moudel = model.fc1
    prune.l1_unstructured(moudel, name="weight", amount=0.88)
    prune.remove(moudel, 'weight')
    moudel = model.fc3
    prune.l1_unstructured(moudel, name="weight", amount=0.88)
    prune.remove(moudel, 'weight')
